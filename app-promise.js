...
var summary = response.data.daily.data[0].summary;
console.log(`Its currently ${temperature} F now. But it already feels like ${apparentTemperature}F`);
console.log(`Tomorrow it may vary between ${dailytempmin}F and ${dailytempmax}F. ${summary}`);
}).catch((e) =>{
if(e.code === 'ENOTFOUND'){
  console.log(e.code);
}else{
